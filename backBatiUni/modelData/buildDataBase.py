...
class CreateNewDataBase:
  listTable = {"UserProfile":UserProfile, "JobForCompany":JobForCompany, "LabelForCompany":LabelForCompany, "Disponibility":Disponibility,"Candidate":Candidate, "Supervision":Supervision, "DetailedPost":DetailedPost, "DatePost":DatePost, "File":File, "Post":Post,  "Company":Company, "Job":Job, "Role":Role, "Label":Label}
  dictLabels = {
