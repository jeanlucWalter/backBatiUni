...
def getDocStr(index = 0):
  file = ["./files/documents/logoFantasiapp.png", "./files/documents/test_1.pdf", "./files/documents/test_2.pdf", "./files/documents/IMG_2465.HEIC", "./files/documents/etex.svg", "./files/documents/batiUni.png", "./files/documents/Fantasiapp.png"]
...
def executeQuery():
  ...
  if query == "register":
    ...
    if query in ["emptyDB", "buildDB","uploadPost", "modifyPost", "switchDraft"]:
      token = queryForToken("jlw", "pwd")
    elif query in ["uploadPost", "modifyPost", "getPost"]:
