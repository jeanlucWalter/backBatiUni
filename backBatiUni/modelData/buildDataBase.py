...
class CreateNewDataBase:
  listTable = {"File":File, "Supervision":Supervision, "ViewPost":ViewPost, "FavoritePost":FavoritePost, "UserProfile":UserProfile, "JobForCompany":JobForCompany, "LabelForCompany":LabelForCompany, "Disponibility":Disponibility,"Candidate":Candidate, "DetailedPost":DetailedPost, "DatePost":DatePost, "Supervision":Supervision, "Post":Post,  "Company":Company, "Job":Job, "Role":Role, "Label":Label}
  dictLabels = {
